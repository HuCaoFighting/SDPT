...
def get_args_parser():
    parser = argparse.ArgumentParser('SDPT training and evaluation script', add_help=False)
    parser.add_argument('--fp32-resume', action='store_true', default=False)
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='SDPT_small', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SDPT training and evaluation script', parents=[get_args_parser()])
